...
Route::prefix('supper')->group(function () {
    Route::get('dashboard', [\App\Http\Controllers\SupperAdminDashboardController::class, 'index'])
        ->name('supper.dashboard.index');

    Route::get('addsubadmin', [AddSubAdminController::class, 'index'])
        ->name('supper.addsubadmin.index');

    Route::post('add-subadmin', [AddSubAdminController::class, 'store'])
        ->name('supper.adduser.store');

    Route::get('fetch-subadmin', [AddSubAdminController::class, 'show'])
        ->name('supper.subadmin.show');
